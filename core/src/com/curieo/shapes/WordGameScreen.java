...
if(texture1 != null && !over && !again) {
    image1 = new Image(texture1);
    image1.setZIndex(3);
    image1.setWidth(4*game.screenWidth/5);
    image1.setHeight(3 * game.screenHeight / 5);
    image1.setPosition(game.screenWidth / 3, 2*game.screenHeight / 7);
